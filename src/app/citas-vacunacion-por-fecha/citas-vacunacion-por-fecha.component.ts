...
@Component({
  selector: 'app-citas-vacunacion-por-fecha',
  templateUrl: './citas-vacunacion-por-fecha.component.html',
  styleUrls: ['./citas-vacunacion-por-fecha.component.css']
})
export class CitasVacunacionPorFechaComponent implements OnInit {
  ...
  async servicio() {
    ...
    await this.httpClient.get("http://localhost:8081/competitors/citasVacunacionPorFecha/"+fecha).subscribe(data => {
      datos = data[0]
